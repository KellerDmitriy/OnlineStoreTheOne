...
protocol SetupMainNavBarProtocol {
    var mainNavigationBar: IMainNavigationBar { get set }
}

// Протокол для настраиваемой навигационной панели
protocol IMainNavigationBar: CustomNavigationBarProtocol {
...
final class CustomNavigationBarImpl: UIView, IMainNavigationBar {
    var title: String = "" {
        didSet {
